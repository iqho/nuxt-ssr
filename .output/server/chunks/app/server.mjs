import { version, unref, inject, hasInjectionContext, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx } from 'vue';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-3ZaZ7eZc.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRouter as a, useRuntimeConfig as b, createError as c, navigateTo as d, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRoute as u };
